      ...
      <div className="space-y-6 mb-8">
        {genders.map((gender) => (
          <motion.button
            ...
            className={`w-full p-8 rounded-3xl border-2 transition-all duration-300 relative overflow-hidden group ${
          ...
          >
            ...
            {selectedGender === gender.id && (
              <motion.div
                ...
                className="absolute top-6 right-6 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center shadow-lg"
              >
